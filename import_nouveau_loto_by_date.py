...
def main():
    ...
    # Import data for a specific date range (focus on 2015-2016 which is our gap)
    # Splitting into smaller chunks to avoid timeouts
    start_date = "2015-06-08"  # Continue from where we left off
    end_date = "2016-05-10"    # End right before where we already have data
